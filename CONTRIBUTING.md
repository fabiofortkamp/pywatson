...
Welcome to the contributor guide of PyWatson.
...
If you experience bugs or general issues with PyWatson, please have a look
...
You can help improve the documentation of PyWatson by making them more readable
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:YourLogin/pywatson.git
   cd pywatson
   ```
